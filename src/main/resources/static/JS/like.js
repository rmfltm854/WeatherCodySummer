...
function handleClickLike(e) {
    ...
    if (loggedIn !== null) {
        ...
        //const stat = e.target.closest('.info-box').querySelector("input").value;
        ...
        $.ajax({
            url: "/like",
            method: "GET",
            data: {imgSrc: imgSrc, action: isLiked ? "unlike" : "like", gender : gender,stat:stat}, // 좋아요 상태에 따라 "like" 또는 "unlike" 값 전송,, 쿠키값 보내야 한다고 하면 추가,cookieValue: getCookie('loggedIn')
            dataType: "json",
